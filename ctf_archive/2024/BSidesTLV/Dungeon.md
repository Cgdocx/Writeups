...
Files [AWS_SECRET_REMOVED]urnal/journal.properties and shattered-pixel-dungeon-[AWS_SECRET_REMOVED]rnal/journal.properties differ
Files [AWS_SECRET_REMOVED]ms.png and shattered-pixel-dungeon-[AWS_SECRET_REMOVED]s.png differ
Files [AWS_SECRET_REMOVED]pixel/shatteredpixeldungeon/Dungeon.java and shattered-pixel-dungeon-[AWS_SECRET_REMOVED]ixel/shatteredpixeldungeon/Dungeon.java differ
Files [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]keletonKey.java and shattered-pixel-dungeon-[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]eletonKey.java differ
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/bsides/Dungeon]
└─$ diff shattered-pixel-dungeon-[AWS_SECRET_REMOVED]rnal/journal.properties [AWS_SECRET_REMOVED]urnal/journal.properties
8,9c8,9
...
┌──(user@kali)-[/media/sf_CTFs/bsides/Dungeon]
└─$ diff shattered-pixel-dungeon-[AWS_SECRET_REMOVED]ixel/shatteredpixeldungeon/Dungeon.java [AWS_SECRET_REMOVED]pixel/shatteredpixeldungeon/Dungeon.java
220c220,246
<
---
>
...
┌──(user@kali)-[/media/sf_CTFs/bsides/Dungeon]
└─$ diff shattered-pixel-dungeon-[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]eletonKey.java [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]keletonKey.java
36c36,38
<
---
>
