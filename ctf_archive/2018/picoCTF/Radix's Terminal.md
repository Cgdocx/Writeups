...
[AWS_SECRET_REMOVED]c1lfNzU3NDAyNTF9
Congrats, now where's my flag?
[AWS_SECRET_REMOVED]opqrstuvwxyz0123456789+/
...
```console
root@kali:/media/sf_CTFs/pico/Radixs_Terminal# echo "[AWS_SECRET_REMOVED]c1lfNzU3NDAyNTF9" | base64 -d && echo
