...
```html
 <body>
  ...
  function auth(n) {
    ...
    var a = "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]kRQEsMzDhBPMrSycaHGWMDpY";
    else a = "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]"; 
     r(a)
  }
  </script>
