...
```console
root@kali:/media/sf_CTFs/google/obscurety/new# file [AWS_SECRET_REMOVED]5c2853232e4c1bafcb632383
[AWS_SECRET_REMOVED]5c2853232e4c1bafcb632383: Zip archive data, at least v2.0 to extract
```

Unzipping it reveals another zip file:
```console
root@kali:/media/sf_CTFs/google/obscurety/new# unzip [AWS_SECRET_REMOVED]5c2853232e4c1bafcb632383
Archive:  [AWS_SECRET_REMOVED]5c2853232e4c1bafcb632383
...
time.sleep(1)
os.mkdir(OUTPUT_DIR)
shutil.copy("[AWS_SECRET_REMOVED]5c2853232e4c1bafcb632383", os.path.join(OUTPUT_DIR, str(counter)))
...
65/password.txt:$pkzip2$1*2*2*0*2c*20*4341ba5d*0*46*0*2c*4341*6eab*[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ba92a613*$/pkzip2$:password.txt:65::output/65
