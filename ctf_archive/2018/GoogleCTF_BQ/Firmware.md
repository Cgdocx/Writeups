...
```console
root@kali:/media/sf_CTFs/google/firmware# file [AWS_SECRET_REMOVED]30cee9357113c54fd3fc84bf
[AWS_SECRET_REMOVED]30cee9357113c54fd3fc84bf: Zip archive data, at least v2.0 to extract
```

Unzip it:
```console
root@kali:/media/sf_CTFs/google/firmware# unzip [AWS_SECRET_REMOVED]30cee9357113c54fd3fc84bf
Archive:  [AWS_SECRET_REMOVED]30cee9357113c54fd3fc84bf
...
[AWS_SECRET_REMOVED]30cee9357113c54fd3fc84bf  challenge.ext4
```
