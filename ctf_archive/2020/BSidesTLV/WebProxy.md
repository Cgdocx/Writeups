...
[PayloadAllTheThings](https://github.[AWS_SECRET_REMOVED]b/master/Server%20Side%20Request%20Forgery/README.md#ssrf-exploiting-redis) has a great recipe for exploiting this:
```
# Getting a webshell
...
def send_to_proxy(csurl):
    ...
    cookies = cookies = {'BSidesTLV': '[AWS_SECRET_REMOVED]'}
