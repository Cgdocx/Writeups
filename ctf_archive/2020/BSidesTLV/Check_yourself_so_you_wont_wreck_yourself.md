...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf# file checkyourself.E01
...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf# mkdir rawimage
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf# ewfmount checkyourself.E01 ./rawimage/
ewfmount 20140807

root@kali:/media/sf_[AWS_SECRET_REMOVED]lf# fdisk -l rawimage/ewf1
...
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf# mkdir mountpoint
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf# mount ./rawimage/ewf1 ./mountpoint -o ro,loop,show_sys_files,streams_interace=windows,offset=$((1320960*512))
```

Now we can explore the mounted image:

```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint# ls
...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint# cd Documents\ and\ Settings/BSIDESTLV2020/
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/Documents and Settings/BSIDESTLV2020# ls
...
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/Documents and Settings/BSIDESTLV2020# cd Recent
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/Documents and Settings/BSIDESTLV2020/Recent# ls
...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/Documents and Settings/BSIDESTLV2020/Recent# strings BSIDESTLV2020.lnk
Pw[
BSIDES~1.TXT
Pw[.
...
Let's look for it:
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/Documents and Settings/BSIDESTLV2020/Recent# cd ../Desktop
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/Documents and Settings/BSIDESTLV2020/Desktop# ls
...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint# cd \$Recycle.Bin/
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/$Recycle.Bin# find . -type f -name '*.txt'
...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]lf/mountpoint/$Recycle.Bin# cat ./S-1-5-21-3498983559-1615527653-2205644034-1001/\$R0K6T9B.txt
...
```console
root@kali:~# umount /media/sf_[AWS_SECRET_REMOVED]lf/mountpoint
root@kali:~# umount /media/sf_[AWS_SECRET_REMOVED]lf/rawimage
```