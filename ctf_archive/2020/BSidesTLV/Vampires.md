...
We see that "TLSv1.2 vulnerable to heartbleed". Let's grab a [PoC script](https://github.com/offensive-[AWS_SECRET_REMOVED]multiple/remote/32745.py) and try it:
```console
