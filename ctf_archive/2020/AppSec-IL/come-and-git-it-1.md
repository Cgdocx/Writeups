...
commit [AWS_SECRET_REMOVED] (HEAD -> headmistresses-tiptoes-bezzled, tag: headmistresses-tiptoes-bezzled-tag, origin/headmistresses-tiptoes-bezzled)
...
commit [AWS_SECRET_REMOVED] (origin/master, origin/HEAD, master)
...
```console
root@kali:/media/sf_CTFs/appsec/come-and-git-it-1/ctf-repo# git log -p -1 [AWS_SECRET_REMOVED]
commit [AWS_SECRET_REMOVED]
Author: Shay Nehmad <dude500@gmail.com>
Date:   Sat Oct 10 20:02:59 2020 +0300
