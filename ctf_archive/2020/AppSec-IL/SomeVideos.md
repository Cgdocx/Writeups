...
```javascript
      ...
      if (location.hash == '#debug') {
      	console.log('Current anti CSRF token is [AWS_SECRET_REMOVED]ZfA=');
              ...
              <div class="navbar-dropdown"><a class="navbar-item" href="/videos">Your videos</a>
                ...
                <div class="navbar-item">
                  <form action="/logout" method="POST">
                    <input type="hidden" name="csrf" value="[AWS_SECRET_REMOVED]2LI=">
                    <div class="field">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <form action="/videos" method="POST">
                  <input class="input" type="hidden" name="csrf" value="[AWS_SECRET_REMOVED]2LI=">
                  <div class="field">
                    <div class="control">
