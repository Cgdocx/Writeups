...
commit [AWS_SECRET_REMOVED] (HEAD -> aghastness-subhead-cyrtometer)
Author: Fake Name <fake@mail.com>
Date:   Tue Oct 27 00:07:21 2020 +0200

    Each push, the awesome build system will build

commit [AWS_SECRET_REMOVED] (tag: aghastness-subhead-cyrtometer-tag, origin/aghastness-subhead-cyrtometer)
