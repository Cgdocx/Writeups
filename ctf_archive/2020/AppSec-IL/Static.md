...
x-amz-id-2: [AWS_SECRET_REMOVED]DCoU31gTqOkAxalalnBBdop8oW3/fcazfw4=
...
Report-To: {"endpoints":[{"url":"https:\/\/a.nel.cloudflare.com\/report?s=FO9ZoK9uuH0KVaiA0%2BUraPKdZglXwTN94bpd3VyZjKvyDJBvc%[AWS_SECRET_REMOVED]qwUqSoE%2FP1j7GHVXt8zSf8N41HBqivr5"}],"group":"cf-nel","max_age":604800}
...
.[AWS_SECRET_REMOVED]1e0fafa76dcce
.[AWS_SECRET_REMOVED]c5a41d86ce96e
.[AWS_SECRET_REMOVED]0c06f5b1f2bee
.[AWS_SECRET_REMOVED]06bc5430749f3
.[AWS_SECRET_REMOVED]4cdb0e7a138aa
.[AWS_SECRET_REMOVED]717ae291d8ecd
.[AWS_SECRET_REMOVED]ad208cdf28a4c
.[AWS_SECRET_REMOVED]3f59dc2a6a6f9
...
<?xml version="1.0" encoding="UTF-8"?>
<Error><Code>AccessDenied</Code><Message>Access Denied</Message><RequestId>B4E3B7A68A324EBA</RequestId><HostId>[AWS_SECRET_REMOVED]pt6eT0WrgZL7sjy1Sns9u53wpu2jMW9c3g8=</HostId></Error>
```
...
-AWS_KEY = "[AWS_KEY_REMOVED]"
-AWS_SECRET = "[AWS_SECRET_REMOVED]"
 BUCKET_NAME = "static.appsecil.ctf.today"
+with open("config.json") as config_file:
+    config = json.load(config_file)
...
```console
root@kali:/media/sf_CTFs/appsec/Static# export AWS_ACCESS_KEY_ID=[AWS_KEY_REMOVED]
root@kali:/media/sf_CTFs/appsec/Static# export AWS_SECRET_ACCESS_KEY=[AWS_SECRET_REMOVED]
