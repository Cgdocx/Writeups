...
< set-cookie: access_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]cy5uZXQifQ.[AWS_SECRET_REMOVED]q3A; Path=/; SameSite=lax
< set-cookie: user_id=5f8b2e54a5b8134d764f65a8; Path=/; SameSite=lax
```

The first one is a JWT with the user email:
```console
root@kali:/media/sf_CTFs/appsec/HR_Agency# python3 ~/utils/jwt_tool/jwt_tool.py eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]cy5uZXQifQ.[AWS_SECRET_REMOVED]q3A
