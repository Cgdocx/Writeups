...
Using a larger query from [PayloadAllTheThings](https://github.[AWS_SECRET_REMOVED]e/master/GraphQL%20Injection) ("Enumerate Database Schema via Introspection"), we can dump many more details from the schema. Here's what that query shows about the `leads`:
