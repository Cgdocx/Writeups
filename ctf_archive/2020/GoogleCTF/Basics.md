...
Output: 
```
current   = [AWS_SECRET_REMOVED]0000000000000000
expected  = [AWS_SECRET_REMOVED]1101101111001100
open_safe = 0
```
...
Output:
```
current   = [AWS_SECRET_REMOVED]0011111110000000
expected  = [AWS_SECRET_REMOVED]1101101111001100
open_safe = 0
```
...
Output:
```
current   = [AWS_SECRET_REMOVED]0001101110000000
expected  = [AWS_SECRET_REMOVED]1101101111001100
open_safe = 0
```
...
And the output:
```
current   = [AWS_SECRET_REMOVED]1101101111001100
expected  = [AWS_SECRET_REMOVED]1101101111001100
open_safe = 1
```
