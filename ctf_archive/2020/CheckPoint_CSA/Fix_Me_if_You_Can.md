...
imagedata           .. text: "+++444***"
b1,rgb,lsb,xy       .. text: "48:[AWS_SECRET_REMOVED]NHhZek45"
...
```console
root@kali:/media/sf_CTFs/checkpoint/Fix_Me_if_You_Can# echo "[AWS_SECRET_REMOVED]NHhZek45" | base64 -d && echo
Q1NBe1N0MzlhTjBfIW5fZDBjXzFzX04xYzN9
root@kali:/media/sf_CTFs/checkpoint/Fix_Me_if_You_Can# echo "[AWS_SECRET_REMOVED]NHhZek45" | base64 -d | base64 -d && echo
