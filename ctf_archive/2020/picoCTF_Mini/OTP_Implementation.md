...
```
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]1776f727434e6b6227d1
```
...
```console
root@kali:/media/sf_CTFs/pico/OTP_Implementation# ./otp [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]1776f727434e6b6227d1
Invalid key!
```
  ...
  if (argc < 2) {
    ...
    if (i == 100) {
      iVar2 = strncmp(jumbled_input,
                      "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]noaknjlnlaohboimombk"
                      ,100);
      if (iVar2 == 0) {
...
EXPECTED = '[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]noaknjlnlaohboimombk'
...
flag: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]1776f727434e6b6227d1
key : [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]481596117a7c5e5217ac
