...
*************************/
  POTENZA.scrolltotop = function () {  
      ...
      $scrolltop.on('click', function () {
		  ...
		  setTimeout(function(){ 
			$('<div id="gratz" style="position:fixed; top: 5px; width: 100%; padding: 10px; z-index: 999999"><div style="background: #df1212; border: 1px solid white; padding: 10px; color: white; text-align: center">Congratulations, you got a flag ;) '+atob("[AWS_SECRET_REMOVED]M2UyOWI1fQ==")+'</div></div>').appendTo($('body'))
			$('#gratz').fadeIn()
		  },600);
...
```javascript
atob("[AWS_SECRET_REMOVED]M2UyOWI1fQ==")
...
```
eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]Y2Vzc19sZXZlbCI6NX0.8LOXY75j_XPYmBiIz-kA5JlMZLHJnsKCl2ap3xuUsNQ
```
...
```console
root@kali:/media/sf_CTFs/hackazon/CyberTank_Website/jwt# python ../../../pico/JaWT_Scratchpad/jwt2john.py eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]Y2Vzc19sZXZlbCI6NX0.8LOXY75j_XPYmBiIz-kA5JlMZLHJnsKCl2ap3xuUsNQ > jwt.john
root@kali:/media/sf_CTFs/hackazon/CyberTank_Website/jwt# cat jwt.john
eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]Y2Vzc19sZXZlbCI6NX0#[AWS_SECRET_REMOVED]c99ec2829766a9df1b94b0d4
...
```
eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]Y2Vzc19sZXZlbCI6MX0.6XoD_y9eXpHbW772jNuZRbKS3e1hjeKmYgCzMfpmBtY
```
