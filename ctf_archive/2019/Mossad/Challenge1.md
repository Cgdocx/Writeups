...
[AWS_SECRET_REMOVED].smali:1:.class public Lcom/iwalk/locksmither/MainActivity;
...
Cfile:///C:[AWS_SECRET_REMOVED]her/lib/main.dart
import 'package:locksmither/routes.dart';
Mfile:///C:[AWS_SECRET_REMOVED]her/lib/models/AuthURL.dart
Kfile:///C:[AWS_SECRET_REMOVED]her/lib/models/token.dart
Qfile:///C:[AWS_SECRET_REMOVED]her/lib/network/cookie_jar.dart
Iimport 'package:locksmither/models/token.dart';
Vfile:///C:[AWS_SECRET_REMOVED]her/lib/network/network_actions.dart
...
Vfile:///C:[AWS_SECRET_REMOVED]her/lib/network/network_wrapper.dart
Nfile:///C:[AWS_SECRET_REMOVED]her/lib/pages/home_page.dart
import 'package:locksmither/network/cookie_jar.dart';
import 'package:locksmither/models/token.dart';
Ofile:///C:[AWS_SECRET_REMOVED]her/lib/pages/login_page.dart
import 'package:locksmither/network/network_actions.dart';
import 'package:locksmither/network/cookie_jar.dart';
import 'package:locksmither/models/token.dart';
Efile:///C:[AWS_SECRET_REMOVED]her/lib/routes.dart
...
We search `kernel_blob.bin` for all locations of the user application (i.e. paths that start with "`file:///C:[AWS_SECRET_REMOVED]her/`") and extract the following files:
