...
> Look at what I found! [AWS_SECRET_REMOVED]T10aYBpIVwlbCVZATl1WTBpaTkBOQFVcSQdH
...
```console
root@kali:/media/sf_CTFs/tamu/Smiley# echo [AWS_SECRET_REMOVED]T10aYBpIVwlbCVZATl1WTBpaTkBOQFVcSQdH | base64 -d
...
```python
>>> "".join(chr(ord(x) ^ 0x3a) for x in base64.b64decode("[AWS_SECRET_REMOVED]T10aYBpIVwlbCVZATl1WTBpaTkBOQFVcSQdH"))
...
s = "[AWS_SECRET_REMOVED]T10aYBpIVwlbCVZATl1WTBpaTkBOQFVcSQdH"
