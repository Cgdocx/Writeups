...
class VaultDoor5 {
    ...
    public boolean checkPassword(String password) {
        ...
        String expected = "[AWS_SECRET_REMOVED]JTVm"
                        + "[AWS_SECRET_REMOVED]JTM2"
                        + "[AWS_SECRET_REMOVED]";
...
> decodeURIComponent(Buffer.from("[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]JTYyJTYx", 'base64').toString());
