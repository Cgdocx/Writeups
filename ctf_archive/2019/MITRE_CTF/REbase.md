...
4
rUC/C/==
[AWS_SECRET_REMOVED]X2YCD/F5Ih8=
Try Again :(
...
1n
root@kali:/media/sf_CTFs/mitre/rebase# echo [AWS_SECRET_REMOVED]X2YCD/F5Ih8= | base64 -d && echo
N2_fy"s
```
...
Base64 is based on a dictionary of 64 characters where every character represents an index. The standard dictionary is `"[AWS_SECRET_REMOVED]opqrstuvwxyz0123456789+/"`. 
...
NNNN !"#NNNN$%&'NNNN()*+NNNN,-./NNNN0123NNNN4567NNNN89:;NNNN<=>?NNNN@[AWS_SECRET_REMOVED]VWXNNNNYZ[\NNNN]^_`[AWS_SECRET_REMOVED]NNNNuvwxNNNNyz{|NNNN}~
...
[AWS_SECRET_REMOVED]ghjklzxcvbn/+m1234567890
...
def test_base64():
    ...
    dictionary = "[AWS_SECRET_REMOVED]opqrstuvwxyz0123456789+/"
...
if __name__ == "__main__":
    ...
    dictionary =  "[AWS_SECRET_REMOVED]ghjklzxcvbn/+m1234567890"
    print(base64_decode("[AWS_SECRET_REMOVED]X2YCD/F5Ih8=", dictionary), end='')
```
...
39
[AWS_SECRET_REMOVED]X2YCD/F5IlAy
[AWS_SECRET_REMOVED]X2YCD/F5Ih8=
Try Again :(
```
...
root@kali:/media/sf_CTFs/mitre/rebase# ./REBase-fix MCA{Th15_wUz_EaZy_Pe@Zy_L3m0n_SqU33zy{
38
[AWS_SECRET_REMOVED]X2YCD/F5Ih6=
[AWS_SECRET_REMOVED]X2YCD/F5Ih8=
Try Again :(
```
