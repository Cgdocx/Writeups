...
gpg:                using RSA key [AWS_SECRET_REMOVED]
gpg: Can't check signature: No public key
```

We delete the keys so that we never accidentally use them after the CTF:
```console
root@kali:/media/sf_CTFs/mitre/warmup# gpg --delete-secret-key [AWS_SECRET_REMOVED]
...
root@kali:/media/sf_CTFs/mitre/warmup# gpg --delete-key [AWS_SECRET_REMOVED]
gpg (GnuPG) 2.2.12; Copyright (C) 2018 Free Software Foundation, Inc.
This is free software: you are free to change and redistribute it.
There is NO WARRANTY, to the extent permitted by law.
...
<p style="display:none;">MCA{[AWS_SECRET_REMOVED]}</p>
</body>
</html>
```
...
The flag: MCA{[AWS_SECRET_REMOVED]}
