...
We start with:
```
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WURFTUpURzQyQT09PT0=
```

Decode it:
```console
root@kali:/media/sf_CTFs/bsidestlv/The_Lost_Award# echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WURFTUpURzQyQT09PT0= | base64 -d
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]GAZTOMZYGUYDEMJTG42A====
```

This is base32 (all uppercase letters, and equal signs at the end).
Decode that:
```console
root@kali:/media/sf_CTFs/bsidestlv/The_Lost_Award# echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]GAZTOMZYGUYDEMJTG42A==== | base32 -d
[AWS_SECRET_REMOVED]95028393E2037385021374
```

This looks like a hex stream. What is the meaning?
```console
root@kali:/media/sf_CTFs/bsidestlv/The_Lost_Award# echo [AWS_SECRET_REMOVED]95028393E2037385021374 | xxd -p -r | xxd -g 1
...
lNHQVpUT05BPQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]RU1CVEdBWlRBTVpaR00zRElNQlNHQVpUT05BPQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]R01CVEdBWlRTTVpXR1FZREVNQlRHNDJBPT09PQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WVRHT0JWR0FaRENNWlhHUT09PT09PQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WVRHT0JWR0FaRENNWlhHUT09PT09PQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WVRHT0JWR0FaRENNWlhHUT09PT09PQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WVRHT0JWR0FaRENNWlhHUT09PT09PQ==
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]WVRHT0JWR0FaRENNWlhHUT09PT09PQ==
...
```console
echo [AWS_SECRET_REMOVED]95028393E2037385021374 | rev | xxd -p -r
