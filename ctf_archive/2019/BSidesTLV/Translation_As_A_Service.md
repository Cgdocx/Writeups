...
The request is being blocked by a WAF. If it's based on a blacklist, we might be able to bypass it using a different way to express localhost. [PayloadAllTheThings](https://github.[AWS_SECRET_REMOVED]e/master/Server%20Side%20Request%20Forgery) is very helpful with this.
...
ssrf_list = requests.get("https://raw.githubusercontent.[AWS_SECRET_REMOVED]ter/Server%20Side%20Request%20Forgery/README.md")
