...
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]OTE1MDM3NjQ1NTUxMTAwNTc=
...
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]NDI3MDg2MDY3MTQwMjk1ODM=
```

We could later send this to the "execute" API, and see the return value:

```console
root@kali:/media/sf_CTFs/bsidestlv/Secret_Service# curl "http://secretservice.challenges.bsidestlv.com/index.php?action=execute&value=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]OTE1MDM3NjQ1NTUxMTAwNTc=" && echo ""
2
root@kali:/media/sf_CTFs/bsidestlv/Secret_Service# curl "http://secretservice.challenges.bsidestlv.com/index.php?action=execute&value=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]NDI3MDg2MDY3MTQwMjk1ODM=" && echo ""
cat hi.txt
```
...
[AWS_SECRET_REMOVED]9115474741976132427291503764555110057
```
...
[AWS_SECRET_REMOVED]9115474741976132427291503764555110057L
