...
e: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Y1ZRV1l6eHk0WGJ0eUwzVk5Leg==

HEADERS
Connection: close
Via: 1.1 infra-squid (squid/3.5.27), 1.1 76d5d69c7419d6e5ee08d1a87f9d8316.cloudfront.net (CloudFront), 1.1 vegur
Connect-Time: 6
X-Amz-Cf-Id: nfX-[AWS_SECRET_REMOVED]b5ue6k6Iww==
...
```console
root@kali:/media/sf_CTFs/google/Cookie_World_Order# echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Y1ZRV1l6eHk0WGJ0eUwzVk5Leg== | base64 -d
