...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]RedPremium.com# python3 vm.py program
Running ....
http://emoji-t0anaxn
```
...
```
root@kali:/media/sf_[AWS_SECRET_REMOVED]RedPremium.com# python3 disassembler.py program
...
```console
root@kali:/media/sf_[AWS_SECRET_REMOVED]RedPremium.com# curl http://emoji-t0anaxnr3nacpt4na.web.ctfcompetition.com/humans_and_cauliflowers_network/
<!DOCTYPE html>
<meta charset="utf-8">
