...
```
[AWS_SECRET_REMOVED]d29yZDogc3RhcnQtc25pZmZpbmchCg==
```

Let's decode it:
```console
root@kali:/media/sf_CTFs/google/Satellite# echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aWZmaW5nCg== | base64 -d
...
Username: brewtoot password: CTF{[AWS_SECRET_REMOVED]}      166.00 IS-19 2019/05/09 00:00:00       Swath 640km      Revisit capacity twice daily, anywhere Resolution panchromatic: 30cm multispectral: 1.2m        Daily acquisition capacity: 220,000km Remaining config data written to: https://docs.google.com/document/d/14eYPluD_pi3824GAFanS29tWdTcKxP_XUxx7e303-3E
```

We got the flag - CTF{[AWS_SECRET_REMOVED]}.
