...
Such challenges usually lead to [template injection](https://github.[AWS_SECRET_REMOVED]e/master/Server%20Side%20Template%20Injection), so let's try that here:
```console
