...
Turns out Ghidra has a [bug](https://github.[AWS_SECRET_REMOVED]/19) related to patching - it messes up the ELF headers. The bug report offers a workaround but let's try `r2` instead:
