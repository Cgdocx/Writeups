...
c=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]2871673722739401583613920865
N=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]11562287725586162360516841779
d=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]5741809998466654281718606993
```
...
>>> plaintext = pow(c, d, N)
>>> plaintext
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]L
>>> format(plaintext, 'x')
'[AWS_SECRET_REMOVED]2e636f6d2f66696c652f642f31'
...
[AWS_SECRET_REMOVED]AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
