...
| ----------------------------------- | ------------------------------------------------------------------- |
| `[{"l":150,"p":"./../version"}]`    | `Linux version 5.4.89+ (builder@000b7ffa02b3) (Chromium OS 11.0_pre391452_p20200527-r7 clang version 11.0.0 (/var/cache/chromeos-cache/distfiles/host/egit-src/llvm-project [AWS_SECRET_REMOVED])) #1 SMP Sat Feb 13 19:45:14 PST 2021"` |
