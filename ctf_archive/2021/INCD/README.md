...
>
> Your leak indicators: INCDGOV [AWS_SECRET_REMOVED] 
>
> Good luck !

We search Google for the phrase *"where over 65 million developers share the future of software, together"* and find GitHub.

From there we find [this commit](https://github.com/INCDGOV/Junior_[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]5a306b1c50).
