...
┌──(user@kali)-[/media/sf_CTFs/google/16_Unknown_-_Prison_Cell_2]
└─$ xxd -p msg1.bin | tr -d '\n'
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]2874b61a1533d7e4ab05887c

┌──(user@kali)-[/media/sf_CTFs/google/16_Unknown_-_Prison_Cell_2]
└─$ xxd -p msg2.bin | tr -d '\n'
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]2874b61a1533d764ab05887c
```
