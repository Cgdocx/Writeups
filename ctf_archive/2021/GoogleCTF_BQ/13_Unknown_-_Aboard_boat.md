...
.....
        211
.~..{"militaryGradeEncryption":true,"codename":"BadGuy87","message":"[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]34280c0c21a53a241218"}
89
..6>..+...,...;...mC..:...,...!...mC.. ...~J..c[..<
..*[..yN..{...{L..|M..m.
        77
...
```javascript
>>> decryptWithMilitaryGradeEncryption("[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]34280c0c21a53a241218")
"zip's password is [AWS_SECRET_REMOVED]HaveToDo1234"
...
└─$ unzip -P [AWS_SECRET_REMOVED]HaveToDo1234 flag.zip
Archive:  flag.zip
 extracting: flag.txt

┌──(user@kali)-[/media/…/google/13_Unknown_-_Aboard_boat/download/exported_objects]
└─$ cat flag.txt
CTF{[AWS_SECRET_REMOVED]u}
```
