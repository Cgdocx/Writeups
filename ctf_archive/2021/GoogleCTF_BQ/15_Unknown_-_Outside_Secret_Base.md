...
a = [AWS_SECRET_REMOVED]00000000010001000100010000 # 0x0100101000011110
b = [AWS_SECRET_REMOVED]00000000100010001000100000 # 0x2002220020022220
c = [AWS_SECRET_REMOVED]00000001000100010000000000 # 0x4444040044044400
d = [AWS_SECRET_REMOVED]00000000000000100010000000 # 0x8880008080000880
```
...
```python
x |= a & [AWS_SECRET_REMOVED]01000100010001000100010001 # 0x1111111111111111
x |= b & [AWS_SECRET_REMOVED]10001000100010001000100010 # 0x2222222222222222
x |= c & [AWS_SECRET_REMOVED]00010001000100010001000100 # 0x4444444444444444
x |= d & [AWS_SECRET_REMOVED]00100010001000100010001000 # 0x8888888888888888
```
