...
(async () => {
    await new Promise(
        ...
        return "YWRtaW4" !== t.u ? alert("Incorrect Username") : "[AWS_SECRET_REMOVED]M3J2M3JfNTNydjNyfQ" !== t.p ? alert("Incorrect Password") : void alert(`Correct Password! Your flag is ${atob(t.p)}.`)
    }))
})();
```
...
└─$ echo [AWS_SECRET_REMOVED]M3J2M3JfNTNydjNyfQ== | base64 -d
