...
┌──(user@kali)-[/media/sf_CTFs/pico/Shop]
└─$ file ./source
./source: ELF 32-bit LSB executable, Intel 80386, version 1 (SYSV), statically linked, Go BuildID=PjavkptB2tPNbBJewQBD/KlDP1g_[AWS_SECRET_REMOVED]jZuAYGqbSv46xuR, with debug_info, not stripped
```
