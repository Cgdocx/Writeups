...
Set-Cookie: auth_name=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]S2l4KzJWTW4=; Path=/
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/pico/More_Cookies]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]S2l4KzJWTW4= | base64 -d
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Kix+2VMn
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/pico/More_Cookies]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Kix+2VMn | base64 -d | xxd -g 1
...
┌──(user@kali)-[/media/sf_CTFs/pico/More_Cookies]
└─$ python3 solve.py
[*] Cookie: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Wk9IeVVIbHk=
[+] Flipping bits: Done
