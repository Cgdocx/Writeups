...
We can use [this module](https://gist.github.[AWS_SECRET_REMOVED]c64bfe#file-manageflasksession-py) to decode it. We just need to try all cookie names and see which one decodes successfully.
