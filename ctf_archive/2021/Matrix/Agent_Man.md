...
[AWS_SECRET_REMOVED]y.java:    public native String agentMan(String str);
[AWS_SECRET_REMOVED]y.java:            textView.setText(agentMan(null));
[AWS_SECRET_REMOVED]y.java:            textView.setText(agentMan(str));
```
...
<!-- End Google Tag Manager -->
  ...
  <body>
      <div style="text-align: center">
        <img src="[AWS_SECRET_REMOVED]/digDeeper.jpg" id="bg"/>
...
```console
root@kali:/media/sf_CTFs/matrix/Agent_Man# wget https://ctfroom.matrixcyberlabs.[AWS_SECRET_REMOVED]e53/digDeeper.jpg
--2021-03-02 23:06:59--  https://ctfroom.matrixcyberlabs.[AWS_SECRET_REMOVED]e53/digDeeper.jpg
