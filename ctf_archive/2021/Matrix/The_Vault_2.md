...
Enter input:
2
Encrypted password: [AWS_SECRET_REMOVED]KCHLDPLOMUXY
Enter input:
-1
bye bye :)
```
...
[*] Encrypted password: '[AWS_SECRET_REMOVED]IZRPROKHYCFT'
[*] Decrypted password: '[AWS_SECRET_REMOVED]RNGALGOIRTHM'
