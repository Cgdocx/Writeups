...
public class MainActivity extends AppCompatActivity {
    ...
    public /* synthetic */ void lambda$onCreate$0$MainActivity(Context context, View view) {
        ...
        try {
            ...
            this.cipher.doFinal(Base64.decode("[AWS_SECRET_REMOVED]wwcXTrlb/l9tELh9RflIpyDT", 0));
...
[AWS_SECRET_REMOVED]MU5nNV9BN3Q0Y2gzZH0=
```
...
Let's decode it:
```console
$ echo [AWS_SECRET_REMOVED]MU5nNV9BN3Q0Y2gzZH0= | base64 -d
