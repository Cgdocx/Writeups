...
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]M0k3MGcifQ.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]YWNjb3VudDplYXJ0aDpjeWJvcmctMTMzNyJ9.09IAfeemd4gGTF_cGwaAojPm5G05QnCkgUbbSzodCd1WDcN1HS0iQ-[AWS_SECRET_REMOVED]5ldN3Q4ID5UBlLwJSlNC8XkxHLUEOYjdB-qZUWUAASCcP3540R7OZ8ldyd-0rlnR7r7L6rDMmP-[AWS_SECRET_REMOVED]I2uLGPnjBGtSike-[AWS_SECRET_REMOVED]SjBJ8E6jaW0Bzr_[AWS_SECRET_REMOVED]0wS3mI5g1kd7DKzgRuv0Cg
```
...
Client Version: version.Info{Major:"1", Minor:"21", GitVersion:"v1.21.3", GitCommit:"[AWS_SECRET_REMOVED]", GitTreeState:"clean", BuildDate:"2021-07-15T21:04:39Z", GoVersion:"go1.16.6", Compiler:"gc", Platform:"linux/amd64"}
...
- apiVersion: v1
  ...
  status:
    ...
    - lastProbeTime: null
      ...
      type: PodScheduled
    containerStatuses:
    - containerID: docker:[AWS_SECRET_REMOVED]1fcef34f8a3c6750e0b36ad9c6
      image: ubuntu@sha256:[AWS_SECRET_REMOVED]90352663418c0f2ed40417fe
      imageID: docker-pullable://ubuntu@sha256:[AWS_SECRET_REMOVED]90352663418c0f2ed40417fe
      lastState: {}
      name: home
      ready: true
      restartCount: 0
...
```
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]M0k3MGcifQ.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].ORxg24s9n23DZ2X651kV_vPH1WRkwDQnE2-1j14u2djpaD_Qz6chGO4MGH6uVnTKMn0xv7MA2N7NisHCm9_[AWS_SECRET_REMOVED]asFy_JHa671TF6WMOAmWTzY-[AWS_SECRET_REMOVED]4juBwzNMJh-[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]zQiFo_l6Nt4LdTB9T2fmeY5FtGC1pyfAqotevvrRWO_FCVyfVcQlz7wSt60Wtuqg
```

We export it for convenience:

```console
[cyborg-1337@earth]# export TOKEN_ACB=[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]M0k3MGcifQ.[AWS_SECRET_REMOVED]dW50Iiwia3ViZXJuZX
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]I4Iiwia3ViZXJuZXRlcy5pby9zZXJ2aWNlYWNj
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Ni1lM2ZlYTBjZGVmMmEiLCJzdWIiOiJzeXN0ZW
[AWS_SECRET_REMOVED]k6YWxwaGEtY2VudGF1cmktYiJ9.ORxg24s9n23DZ2X651kV_vPH1WRkwDQnE2-1j14u2djpaD_Qz6chGO4MGH6uVnTKMn0xv7MA2N7NisHCm9_[AWS_SECRET_REMOVED]asFy_JHa
671TF6WMOAmWTzY-[AWS_SECRET_REMOVED]4juBwzNMJh-[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]zQiFo_l6Nt4LdTB9T2fmeY5FtGC1pyfAqotevvrRWO_FCVyfVcQ
lz7wSt60Wtuqg
```
...
apiVersion: v1
data:
  flag: [AWS_SECRET_REMOVED]d19oMG0zfQo=
kind: Secret
metadata:
  annotations:
    kubectl.kubernetes.io/last-applied-configuration: |
      {"apiVersion":"v1","data":{"flag":"[AWS_SECRET_REMOVED]d19oMG0zfQo="},"kind":"Secret","metadata":{"annotations":{},"name":"centauri1337","namespace":"alpha-centauri"}}
...
```console
[cyborg-1337@earth]# echo [AWS_SECRET_REMOVED]d19oMG0zfQo= | base64 -d
