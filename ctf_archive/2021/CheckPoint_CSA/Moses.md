...
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ENOTSUREIFITWASADOTORALINE    [AWS_SECRET_REMOVED]ESINSIDECURLYBRACKETSAFTERUPPERCASECSA
```
