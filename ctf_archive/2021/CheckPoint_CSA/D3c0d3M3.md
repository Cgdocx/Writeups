...
This is a pretty simple decoding challenge. We need to decode `[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]` according to the instructions we've received.
...
undefined
> chef.bake("[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]", [
... {op: chef.fromBase32},
