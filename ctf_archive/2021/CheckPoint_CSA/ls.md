...
For the first stage, we need to take their provided [assembly source](https://github.[AWS_SECRET_REMOVED]ts/zip.asm), which describes the structure of a dual ZIP file, and edit it for our needs:
...
[AWS_SECRET_REMOVED]  collision1.bin
[AWS_SECRET_REMOVED]  collision2.bin
