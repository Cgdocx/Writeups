...
[AWS_SECRET_REMOVED]355444464034512895
>>> '#0%db' % (flag_len*int(math.log(len(PRINTABLE), 2)) + 2)
'#0194b'
>>> bin([AWS_SECRET_REMOVED]355444464034512895)
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]1111111111111111111111111111111111'
>>> len(bin([AWS_SECRET_REMOVED]355444464034512895))
194
>>>
...
>>> rand_num_func()
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]00101111000010011011100110000001'
>>> rand_num_func()
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]11001000100000010010101110100110'
>>> rand_num_func()
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]00010111100111000101011011110100'
>>> rand_num_func()
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]00101011101101111000110011001011'
>>> len(rand_num_func())
192
...
>>> rand_num
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]00111011011011111001010101111001'
>>> j = 0
>>> for i in range(0,len(rand_num),len(f'{len(PRINTABLE) - 1:b}')):
...
...
>>> rand_num
'[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]11000000110100101110011001100001'
>>> int(rand_num, 2)
[AWS_SECRET_REMOVED]845575377300678241
```
