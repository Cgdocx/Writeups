...
└─$ zbarimg QR-Code.png
QR-Code:https://corgis-web.h4ck.ctfcompetition.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]ZmIxOWRhYTM2OTM5
...
```console
┌──(user@kali)-[/media/…/h4ck1ng.google/EP003/Challenge_03/a]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]OWRhYTM2OTM5 | base64 -d
https://corgis-web.h4ck.ctfcompetition.com/corgi?DOCID=flag&_mac=[AWS_SECRET_REMOVED]b5f40c264fc5fb19daa36939
```
...
```console
┌──(user@kali)-[/media/…/h4ck1ng.google/EP003/Challenge_03/a]
└─$ curl "https://corgis-web.h4ck.ctfcompetition.com/corgi?DOCID=flag&_mac=[AWS_SECRET_REMOVED]b5f40c264fc5fb19daa36939"
<!doctype html>
<html lang=en>
...
```console
┌──(user@kali)-[/media/…/h4ck1ng.google/EP003/Challenge_03/a]
└─$ [AWS_SECRET_REMOVED] -d output challenge.apk
INFO  - loading ...
INFO  - processing ...
...
```xml
    <string name="hmac_shared_secret">[AWS_SECRET_REMOVED]1+0=</string>
```
...
hmac_shared_secret = "[AWS_SECRET_REMOVED]1+0="
...
└─$ python3 solve.py
[-] Signing 'X-DOCUMENT-ID=flag,X-REQUEST-NONCE=[AWS_SECRET_REMOVED]8bef8d42b772cf4e3ed20fbf,X-TIMESTAMP=1665941119,X-USER-SUBSCRIBED=true'

[-] URL: https://corgis-web.h4ck.ctfcompetition.com/corgi?_mac=[AWS_SECRET_REMOVED]bceb110368b1f4107afe5e7b

[-] Headers: {'X-Auth-MAC': '[AWS_SECRET_REMOVED]bceb110368b1f4107afe5e7b', 'X-Document-ID': 'flag', 'X-Request-Nonce': '[AWS_SECRET_REMOVED]8bef8d42b772cf4e3ed20fbf', 'X-Timestamp': '1665941119', 'X-User-Subscribed': 'true'}
