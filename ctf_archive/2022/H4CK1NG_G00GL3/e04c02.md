...
└─$ python3 login.py
{'token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.[AWS_SECRET_REMOVED]Mjc0N30.swmTpk_wQtjITBQBvVEFtlJ23oAoKlx5NBtQl-VbbIY'}
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/h4ck1ng.google/EP004/Challenge_02]
└─$ curl "https://vrp-website-web.h4ck.ctfcompetition.com" --cookie "token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.[AWS_SECRET_REMOVED]Mjc0N30.swmTpk_wQtjITBQBvVEFtlJ23oAoKlx5NBtQl-VbbIY" -s | grep solve
