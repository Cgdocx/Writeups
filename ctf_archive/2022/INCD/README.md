...
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]BgTE7WbOud1P87E
EgaJxMZf1WQNuCSzeGrVad6novTEem
EgaJxMZf1WQNuCSzeGrVad6novTEem
[AWS_SECRET_REMOVED]YWcgaXMgbm90IGhlcmU=
...
undefined
> chef.fromBase64(chef.fromBase62("[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]BgTE7WbOud1P87E"))
...
def remove_chars(string):
    chars = "[AWS_SECRET_REMOVED]PQRSTUVWXYZ"
    for char in chars:
...
if __name__ == '__main__':
    ...
    second_var = "I45gawq$645@[AWS_SECRET_REMOVED]Qe32"
    third_var = 9
    fourth_var = "I45gawq$645@[AWS_SECRET_REMOVED]Qe32"
    fifth_var = ["SOlO", "hEllO", "Tea", "wHat", "Green", "Oolong", "Matcha", "WhIte", "Pu-Erh", "YelLow", "Mulberry black",
           "Chai", "CeiLlon", "Aerobacter","AeroBic", "aerodynaMic", "aeRoFoil", "aerogene", "AeroNauTic", "AerOsoL",
           "AerOSpace", "AeschyluS", "AesOp", "aesthete", "aesThetiC", "afar", "affable", "afair", "affect",
           "AFFectate", "hOrsE", "HorSebacK", "horsedom", "horseflesh", "horsefly", "horSehair", "hoRseMaN",
           "HorSemen", "horsePlAy", "HoRsePower", "HoRSeshOe", "HorsEtaIl", "hOrseWomaN"]
    sixth_var = "I45gawq$645@[AWS_SECRET_REMOVED]Qe32"
    seventh_var = 9
