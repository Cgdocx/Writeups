...
ERROR: Wrong password : last [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]GblRXcE5QUT09
...
```console
┌──(user@kali)-[/media/sf_CTFs/intent/Science_Mission]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED] | base64 -d
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]TXpBZ056SWdOalFnTXpFZ01qRWdOREFnTWpNPQ==

┌──(user@kali)-[/media/sf_CTFs/intent/Science_Mission]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED] | base64 -d | base64 -d
[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]NDAgMjM=

┌──(user@kali)-[/media/sf_CTFs/intent/Science_Mission]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED] | base64 -d | base64 -d | base64 -d
76 33 72 79 35 37 72 30 6e 36 70 34 35 35 77 30 72 64 31 21 40 23

┌──(user@kali)-[/media/sf_CTFs/intent/Science_Mission]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED] | base64 -d | base64 -d | base64 -d | sed 's/ //g'
[AWS_SECRET_REMOVED]4023

┌──(user@kali)-[/media/sf_CTFs/intent/Science_Mission]
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED] | base64 -d | base64 -d | base64 -d | sed 's/ //g' | awk '{ print (length($0) % 2 == 0) ? $0 : 0$0; }' | xxd -p -r
v3ry57r0n6p455w0rd1!@#
```
...
Publisher                       : [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]rooneonezerozero
```
