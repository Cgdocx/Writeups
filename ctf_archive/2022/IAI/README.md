...
└─$ zbarimg _qr1.png
QR-Code:http://Off: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]72656d656775746865
...
┌──(user@kali)-[/media/sf_CTFs/iai]
└─$ zbarimg _qr3.png
QR-Code:http://On: [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]766f6f696e6e616573
...
```python
>>> off = "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]72656d656775746865"
>>> on  = "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]766f6f696e6e616573"
>>> guide = "193329B5ACD33"
>>> bytearray.fromhex(off).decode()
'[AWS_SECRET_REMOVED]remeguthe'
>>> bytearray.fromhex(on).decode()
'[AWS_SECRET_REMOVED]vooinnaes'
>>> format(int(guide, 16), 'b')
'[AWS_SECRET_REMOVED]100110011'
```
...
```python
>>> guide = "[AWS_SECRET_REMOVED]100110011"
>>> off   = "[AWS_SECRET_REMOVED]remeguthe"
>>> on    = "[AWS_SECRET_REMOVED]vooinnaes"
>>> "".join([on[i] if g == "1" else off[i] for i, g in enumerate(guide)])
'[AWS_SECRET_REMOVED]veminutes'
```
