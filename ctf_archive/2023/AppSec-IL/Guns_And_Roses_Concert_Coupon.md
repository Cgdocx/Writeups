...
└─$ [AWS_SECRET_REMOVED] -d output app-release.apk
INFO  - loading ...
INFO  - processing ...
...
public final void onCreate(Bundle bundle) {
    ...
    if (toolbar != null) {
        ...
        contentValues.put("subtitle", "[AWS_SECRET_REMOVED]D0PMz0pU7xDFdw==");
...
class Decrypt {
    public static void main(String[] args) {
        try
        {
            ...
            Base64.Decoder decoder;
            decoder = Base64.getDecoder();
            bArr = decoder.decode("[AWS_SECRET_REMOVED]D0PMz0pU7xDFdw==");
            Cipher cipher = Cipher.getInstance("Blowfish");
            cipher.init(2, secretKeySpec);
