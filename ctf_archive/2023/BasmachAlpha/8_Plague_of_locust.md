...
- If you wanna play a game ask politely!
please
- [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aGlzIG1lc3NhZ2Uu
```
...
>>> dis.dis(script.main)
 ...
 35         298 LOAD_GLOBAL              1 (NULL + print)
            310 LOAD_CONST               8 ('- [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]aGlzIG1lc3NhZ2Uu')
            312 PRECALL                  1
            316 CALL                     1
            326 POP_TOP
