...
> "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]V2FyIElJLg==". 
...
└─$ echo [AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]V2FyIElJLg== | base64 -d
...
```
 ╔══════════════╗ ╔═══════════════════════════════════════════════════════════╗
                  ║                                                           ║
   Spy : Sidney   ║                                                           ║
                  ║      [AWS_SECRET_REMOVED]Ww24Y        ║
 ╚══════════════╝ ║      [AWS_SECRET_REMOVED]QbQgN        ║
 ╔══════════════╗ ║      b2Ty64i5IuVZxpHsZ6GGr860eM7g==                       ║
   .:: Inbox ::.  ║                                                           ║
                  ║      [AWS_SECRET_REMOVED]TFiJZ        ║
      Welcome     ║      [AWS_SECRET_REMOVED]BrFja        ║
      Fire        ║      L2UWucmIMLX+lyEtZtHGD26EmF9g==                       ║
      Important   ║                                                           ║
      Spam        ║      [AWS_SECRET_REMOVED]W1+vL        ║
      Emergency   ║      [AWS_SECRET_REMOVED]Q6Kyc        ║
   -> One11!!1    ║      vxAjuJmJ8TRbxrHcYzWVL07UWM6g==                       ║
      <locked>    ║                                                           ║
      Exit        ║      [AWS_SECRET_REMOVED]V3Y+6        ║
                  ║      [AWS_SECRET_REMOVED]7zc8Q        ║
...
ciphers = [
    "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]RWXw6QbQgNb2Ty64i5IuVZxpHsZ6GGr860eM7g==",
    "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]anPYvBrFjaL2UWucmIMLX+lyEtZtHGD26EmF9g==",
    "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]Zj7N/Q6KycvxAjuJmJ8TRbxrHcYzWVL07UWM6g==",
    "[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]6zzIR7zc8Q9xeqJid/8KOg7HPhD/QI7Ohyj4Sg=="
]
...
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
┌ Key ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED]8d92ca43f193dee47f591549f597a811c8fa67│
│[AWS_SECRET_REMOVED]b41f79019d892be993                                                            │
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
```
 ...
 ╔══════════════╗ ║                                                           ║
   .:: Inbox ::.  ║     Don't forget to recover the key!                      ║
                  ║                                                           ║
      Welcome     ║     [AWS_SECRET_REMOVED]Ggw4E         ║
      Fire        ║     [AWS_SECRET_REMOVED]mobC0         ║
      Important   ║     [AWS_SECRET_REMOVED]EjD20         ║
      Spam        ║     [AWS_SECRET_REMOVED]VY2Vy         ║
      Emergency   ║     [AWS_SECRET_REMOVED]S1k4M         ║
      One11!!1    ║     [AWS_SECRET_REMOVED]gsuRR         ║
   -> Short key   ║     [AWS_SECRET_REMOVED]EMGgx         ║
      Exit        ║     [AWS_SECRET_REMOVED]kFyhH         ║
                  ║     [AWS_SECRET_REMOVED]Y3RmW         ║
                  ║     [AWS_SECRET_REMOVED]VldY3         ║
