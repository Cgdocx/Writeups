...
In theory we could have decoded the raw object manually as well (e.g. using [CyberChef](https://gchq.github.io/CyberChef/#recipe=From_Base85('!-u',true,'z')Zlib_Inflate(0,0,'Adaptive',false,false)&input=[AWS_SECRET_REMOVED]N1BRI0AwSGE%[AWS_SECRET_REMOVED][AWS_SECRET_REMOVED][AWS_SECRET_REMOVED])):
